...
fn main() {
	App::new()
		...
		.add_chime_events(ChimeEventBuilder::from_fn(when_func_a).on_begin(do_func_a))
		.add_chime_events(ChimeEventBuilder::from_fn(when_func_b).on_begin(do_func_b).on_repeat(outlier_func_b))
		.add_chime_events(ChimeEventBuilder::from_fn(when_func_c).on_begin(do_func_c).on_repeat(outlier_func_c))
